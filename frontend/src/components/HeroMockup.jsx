        ...
        <div className={styles.mockupPanel}>
          ...
          <div className={styles.mockupEssayBox}>
            <p className={styles.mockupEssayText}>
              ...
              for 8 years and Taiwan making up most of the rest. Navigating
              these extremes has molded my international perspective, and I
              easily adapt to...
            </p>
          </div>

          <div className={styles.mockupEssayFooter}>
            <span className={styles.mockupBadge}>User Draft</span>
            <span className={styles.mockupWordCount}>482 words</span>
          </div>
        </div>
